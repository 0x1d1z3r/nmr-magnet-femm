...
yoke_width = 2*yoke_thickness + 2* pole_cap_thickness + pole_cap_dist + 2*magnet_width;
...
if centerresflag == 1
    mi_drawrectangle(yoke_thickness+magnet_width+pole_cap_thickness,yoke_thickness+mag_yoke_dist+magnet_height/2-pole_cap_height/2,yoke_width-yoke_thickness-magnet_width-pole_cap_thickness,yoke_thickness+mag_yoke_dist+magnet_height/2+pole_cap_height/2)
    ...
    %LEFT POLE
    mi_drawline(yoke_thickness+magnet_width+pole_cap_thickness,yoke_thickness+mag_yoke_dist+(magnet_height/2)-(pole_cap_height/2),yoke_thickness+magnet_width+pole_cap_thickness,yoke_thickness+mag_yoke_dist+(magnet_height/2)+(pole_cap_height/2))
    %RIGHT POLE
    mi_drawline(pole_cap_dist+yoke_thickness+magnet_width+pole_cap_thickness,yoke_thickness+mag_yoke_dist+(magnet_height/2)-(pole_cap_height/2),pole_cap_dist+yoke_thickness+magnet_width+pole_cap_thickness,yoke_thickness+mag_yoke_dist+(magnet_height/2)+(pole_cap_height/2))
end
%OUTER LINE FOR YOKE
...
%RIGHT MAGNET
mi_drawrectangle(yoke_thickness+2*pole_cap_thickness+pole_cap_dist+magnet_width,yoke_thickness+mag_yoke_dist,yoke_width-yoke_thickness,yoke_height-yoke_thickness-mag_yoke_dist)
%LEFT POLECAP SLOPES
mi_addsegment(yoke_thickness+magnet_width,yoke_thickness+mag_yoke_dist,yoke_thickness+magnet_width+pole_cap_thickness,yoke_thickness+mag_yoke_dist+(magnet_height/2)-(pole_cap_height/2))
mi_addsegment(yoke_thickness+magnet_width,yoke_thickness+mag_yoke_dist+magnet_height,yoke_thickness+magnet_width+pole_cap_thickness,yoke_thickness+mag_yoke_dist+(magnet_height/2)+(pole_cap_height/2))
%RIGHT POLECAP SLOPES
mi_addsegment(yoke_thickness+magnet_width+pole_cap_thickness+pole_cap_dist,yoke_thickness+mag_yoke_dist+(magnet_height/2)-(pole_cap_height/2),yoke_width-yoke_thickness-magnet_width,yoke_thickness+mag_yoke_dist)
mi_addsegment(yoke_thickness+magnet_width+pole_cap_thickness+pole_cap_dist,yoke_thickness+mag_yoke_dist+(pole_cap_height/2)+(magnet_height/2),yoke_width-yoke_thickness-magnet_width,yoke_height-yoke_thickness-mag_yoke_dist);
%SET YOKE BLOCKPROPS
...
for x= 1:round(pole_cap_dist*subdiv+1)
    for y= 1: round(pole_cap_height*subdiv+1)
        xval=yoke_thickness+magnet_width+pole_cap_thickness+1/subdiv*(x-1);
